...
namespace LtiLibrary.NetCore.Clients
{
    ...
    /// <summary>
    /// Helper methods for the Basic Outcomes service introduced in LTI 1.1 + Canvas.
    /// </summary>
    public static class Outcomes1ClientCanvas
    {
        private static readonly XmlSerializer ImsxRequestSerializer;
        private static readonly XmlSerializer ImsxResponseSerializer;

        static Outcomes1ClientCanvas()
        {
            // The XSD code generator only creates one imsx_POXEnvelopeType which has the 
            // imsx_POXEnvelopeRequest root element. The IMS spec says the root element
            // should be imsx_POXEnvelopeResponse in the response.
        ...
        /// <summary>
        /// Send an Outcomes 1.0 with Lti Launch Url for Canvas SpeedGrader ReplaceResult request.
        /// </summary>
        /// <param name="client"></param>
        /// <param name="serviceUrl"></param>
        /// <param name="consumerKey"></param>
        /// <param name="consumerSecret"></param>
        /// <param name="lisResultSourcedId"></param>
        /// <param name="score"></param>
        /// <param name="ltiResponseUrl"></param>
        /// <param name="signatureMethod"></param>
        /// <returns></returns>
        public static async Task<ClientResponse> ReplaceResultWithLtiLaunchResultAsync(HttpClient client, string serviceUrl, string consumerKey, string consumerSecret,
            string lisResultSourcedId, double? score, string ltiResponseUrl, SignatureMethod signatureMethod = SignatureMethod.HmacSha1)
        {
            try
            {
                var imsxEnvelope = new imsx_POXEnvelopeType
                ...
                imsxBody.resultRecord = new ResultRecordType
                {
                    ...
                    result = new ResultType
                    {
                        ...
                        resultData = new LtiReponseType
                        {
                            ltiLaunchUrl = ltiResponseUrl
                        }
                    }
                };
