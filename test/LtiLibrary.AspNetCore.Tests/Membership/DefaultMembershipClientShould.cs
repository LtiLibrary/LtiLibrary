...
{
    public class DefaultMembershipClientShould : IDisposable
    {
        ...
        public DefaultMembershipClientShould()
        {
        ...
        [Fact]
        public async Task ReturnNoMemberships_WhenImageUrlsAreInvalid()
        {
            // Given a working LTI Membership Service endpoint
            // When I call GetMembershipAsync without any filters
